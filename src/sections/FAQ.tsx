...
const faqs = [
  {
    question: 'Which curricula does Kimatu Analytics support?',
    answer: 'Kimatu Analytics fully supports both the Competency-Based Curriculum (CBE) for PP1 through Grade 9, and the 8-4-4 system for Class 1-8 and Form 1-4. The system auto-calculates grades according to each curriculum\'s grading framework.',
  },
  {
    question: 'How does the CBE grade calculation work?',
    answer: 'When teachers upload marks (0-100), our system automatically calculates the CBE sublevel (EE1, EE2, ME1, ME2, AE1, AE2, BE1, BE2), grade (EE, ME, AE, BE), points (1-8), and descriptor. For 8-4-4, it calculates the letter grade (A-E) and points (1-12).',
  },
  {
  ...
  {
    question: 'Does Kimatu Analytics work on mobile devices?',
    answer: 'Yes, Kimatu Analytics is fully responsive and works on smartphones, tablets, and computers. Teachers can mark attendance from their phones, and parents can check results on the go.',
  },
  {
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-[#666666]">
            Everything you need to know about Kimatu Analytics.
          </p>
        </div>
