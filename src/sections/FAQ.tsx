...
const faqs = [
  {
    question: 'Which curricula does CBE-Analytics support?',
    answer: 'CBE-Analytics fully supports both the Competency-Based Curriculum (CBE) for PP1 through Grade 9, and the 8-4-4 system for Class 1-8 and Form 1-4. The system auto-calculates grades according to each curriculum\'s grading framework.',
  },
  {
