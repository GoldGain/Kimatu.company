...
const testimonials = [
  ...
  },
  {
    ...
    image: 'PO',
    color: 'bg-purple-500',
    content: 'As an 8-4-4 institution, we needed a system that understood the Kenyan education system. CBE-Analytics delivers perfectly. The analytics dashboard gives us insights we never had before.',
    rating: 5,
  },
  {
