...
const testimonials = [
  {
    ...
    image: 'JM',
    color: 'bg-blue-500',
    content: 'Kimatu Analytics has transformed how we manage our school. The CBE grading automation alone saves our teachers hours of work every term. The fee management system is intuitive and parents love being able to check balances instantly.',
    rating: 5,
  },
  {
    ...
    image: 'GW',
    color: 'bg-green-500',
    content: 'We switched from manual record-keeping to Kimatu Analytics and the difference is night and day. Our report cards are generated instantly, and the attendance tracking has improved our student retention significantly.',
    rating: 5,
  },
  {
    ...
    image: 'PO',
    color: 'bg-purple-500',
    content: 'As an 8-4-4 institution, we needed a system that understood the Kenyan education system. Kimatu Analytics delivers perfectly. The analytics dashboard gives us insights we never had before.',
    rating: 5,
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-[#666666] max-w-2xl mx-auto">
            Hear from educators, administrators, and parents who trust Kimatu Analytics.
          </p>
        </div>
