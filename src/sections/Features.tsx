...
const features = [
  ...
  },
  {
    ...
    description: 'Auto-calculate CBE grades (EE, ME, AE, BE) and 8-4-4 grades from raw marks. Generate report cards instantly.',
    color: 'bg-green-500',
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            A comprehensive suite of tools designed specifically for Kenyan schools, supporting both CBE and 8-4-4 curricula.
          </p>
        </div>
