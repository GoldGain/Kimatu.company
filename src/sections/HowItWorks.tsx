...
const steps = [
  ...
  },
  {
    ...
    description: 'Teachers download CSV templates, enter student marks, and upload. The system auto-calculates CBE or 8-4-4 grades.',
    color: 'bg-green-500',
  },
  {
    number: '03',
...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-16 md:py-20 bg-[#F5F3EF]" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-[#666666] max-w-2xl mx-auto">
            Get your school up and running on Kimatu Analytics in minutes, not days.
          </p>
        </div>
