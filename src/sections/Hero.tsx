...
const CAROUSEL_IMAGES = [
  { src: '/images/hero1.jpg', caption: 'Empowering Learners Across Kenya' },
  { src: '/images/hero2.jpg', caption: 'Smart Analytics for Every School' },
  { src: '/images/hero3.jpg', caption: 'Real-Time Progress Tracking' },
  { src: '/images/hero4.jpg', caption: 'Celebrating Academic Excellence' },
  { src: '/images/hero5.jpg', caption: 'Technology-Enhanced Learning' },
];
  ...
  const handleDownload = async () => {
    ...
    if (!installed) {
      ...
      if (isIOS) {
        ...
        alert('To install: Open this site in Chrome or Edge, then tap the browser menu then "Install App" or "Add to Home Screen"');
      }
    }
  };
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-auto">
          ...
          <div className="hero-card md:col-span-7 md:row-span-2 bg-[#1A1A1A] rounded-2xl p-6 md:p-8 text-white relative overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.3)] transition-shadow duration-200">
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm text-gray-400">Kenya&apos;s Leading School Platform</span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-2">
                An Intelligent School
              </h1>
              <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-6 text-[#D4AF37]">
                Management System
              </h1>
              <p className="text-xl font-semibold text-[#D4AF37] mb-4">Smarter Schools, Brighter Futures</p>
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <Link to="/auth/login" className="inline-flex items-center gap-2 bg-[#D4AF37] text-[#1A365D] px-5 py-2.5 rounded-full text-sm font-bold hover:bg-[#F0D060] transition-colors">
                  Login to Your School <ArrowRight className="w-4 h-4" />
                </Link>
                <Link to="/get-started" className="inline-flex items-center gap-2 border border-gray-600 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-gray-800 transition-colors">
                  Get Started
                </Link>
                <a 
          ...
          <div className="hero-card md:col-span-4 md:row-span-2 bg-white rounded-2xl p-6 border-4 border-[#1A1A1A] relative overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.3)] transition-shadow duration-200">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-4">Schools Using Kimatu Analytics</p>
            </div>
            <div className="flex justify-center gap-2 mb-4">
              {['CBE', '8-4-4'].map((tag, i) => (
                <span key={i} className="text-xs bg-[#D4AF37] px-3 py-1 rounded-full font-medium">
                  {tag}
                </span>
              ))}
            </div>
            <div className="bg-[#D4AF37]/30 rounded-xl p-4 text-center">
            ...
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-[#D4AF37] rounded-full opacity-20" />
          </div>
