...
export default function DataProcessingAgreement() {
  return (
    <>
      <SEO
        title="Data Processing Agreement - Kimatu Analytics"
        description="The Data Processing Agreement between subscribing schools (data controllers) and Kimatu Analytics (data processor)."
        ...
        <div className="bg-gradient-to-r from-[#1a237e] to-[#3949ab] text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/80 max-w-2xl">
              ...
              schools engage Kimatu Analytics to process personal data, in line with the{' '}
        ...
        <div className="container mx-auto px-4 py-10 max-w-4xl">
          ...
          <Section title="1. Parties and Roles">
            <ul>
              ...
              <li><strong>Data Processor:</strong> Kimatu Analytics, which processes personal data on the documented instructions of the school to provide its services.</li>
            </ul>
          </Section>

          <Section title="2. Subject Matter and Duration">
            <p>
              Kimatu Analytics processes personal data for the purpose of providing school
          ...
          <Section title="5. Sub-Processors">
            <p>Kimatu Analytics uses the following categories of sub-processors:</p>
            <ul>
