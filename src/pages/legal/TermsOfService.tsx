...
export default function TermsOfService() {
  return (
    <>
      <SEO
        title="Terms of Service - Kimatu Analytics"
        description="Terms governing the use of the Kimatu Analytics school management platform."
        path="/terms"
      />
      <div className="min-h-screen bg-gray-50">
        <div className="bg-gradient-to-r from-[#1a237e] to-[#3949ab] text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/80 max-w-2xl">
              These terms govern your access to and use of the Kimatu Analytics platform. Please
        ...
        <div className="container mx-auto px-4 py-10 max-w-4xl">
          ...
          <Section title="1. Acceptance of Terms">
            <p>
              By registering for or using Kimatu Analytics, the subscribing school and its
          ...
          <Section title="2. Description of Service">
            <p>
              Kimatu Analytics is a cloud-based school management system providing learner
              ...
              the Kimatu Copilot AI assistant and the Pathway Finder career guidance tool.
            </p>
          </Section>
          ...
          <Section title="6. Intellectual Property">
            <p>
              The platform, its software, designs, and content are owned by Kimatu Analytics and are
          ...
          <Section title="8. Disclaimers and Limitation of Liability">
            <p>
              ...
              by law. To the maximum extent permitted by law, Kimatu Analytics shall not be liable
          ...
          <Section title="9. AI-Generated Content">
            <p>
              Kimatu Copilot, AI comments, and Pathway Finder recommendations are generated
