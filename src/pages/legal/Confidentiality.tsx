...
export default function Confidentiality() {
  return (
    <>
      <SEO
        title="Confidentiality Policy - Kimatu Analytics"
        description="How Kimatu Analytics protects the confidentiality of school, learner, and staff information."
        ...
        <div className="bg-gradient-to-r from-[#1a237e] to-[#3949ab] text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/80 max-w-2xl">
              Kimatu Analytics treats school, learner, and staff information as strictly
        ...
        <div className="container mx-auto px-4 py-10 max-w-4xl">
          ...
          <Section title="1. Scope of Confidential Information">
            ...
            <ul>
              ...
              <li>Any non-public information shared with Kimatu Analytics during onboarding or support.</li>
            </ul>
          </Section>

          <Section title="2. Confidentiality Obligations">
            <ul>
              <li>Kimatu Analytics staff access school data only when necessary to provide or support the service, and under confidentiality agreements.</li>
          ...
          <Section title="5. Breach Notification">
            <p>
              In the event of a breach affecting the confidentiality of school data, Kimatu
