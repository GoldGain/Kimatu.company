...
export default function CookiePolicy() {
  return (
    <>
      <SEO
        title="Cookie Policy - Kimatu Analytics"
        description="Cookies and browser storage used by the Kimatu Analytics platform."
        path="/cookie-policy"
      />
        ...
        <div className="bg-gradient-to-r from-[#1a237e] to-[#3949ab] text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/80 max-w-2xl">
              Kimatu Analytics uses only the cookies and browser storage essential to operate the
