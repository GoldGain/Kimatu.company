...
export default function PrivacyPolicy() {
  return (
    <>
      <SEO
        title="Privacy Policy - Kimatu Analytics"
        description="How Kimatu Analytics collects, uses, and protects your personal data in compliance with the Kenya Data Protection Act, 2019."
        path="/privacy"
      />
      <div className="min-h-screen bg-gray-50">
        <div className="bg-gradient-to-r from-[#1a237e] to-[#3949ab] text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/80 max-w-2xl">
              Kimatu Analytics is committed to protecting your privacy. This policy explains how we
        ...
        <div className="container mx-auto px-4 py-10 max-w-4xl">
          ...
          <Section title="1. Introduction" >
            <p>
              Kimatu Analytics ("we", "us", "our") is a school management platform serving Kenyan
