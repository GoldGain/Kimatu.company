...
export default function SchoolRegister() {
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      const message = `Your Kimatu Analytics school verification code is: ${newOtp}. Do not share this code with anyone.`;
      ...
      if (result.success) {
        ...
        (window as any)._kimatu_otp = newOtp;
  ...
  const verifyOtp = async () => {
    ...
    const localOtp = (window as any)._kimatu_otp;
