...
function getPathwayRecommendation(results: any[]): { text: string; focus: string[] } {
  ...
  return {
    ...
    focus: ['Meet with your class teacher for guidance', 'Identify one subject to improve first', 'Use the Kimatu Analytics resources section', 'Consider peer tutoring programs']
  };
}
