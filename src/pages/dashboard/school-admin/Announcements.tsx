  ...
  const generateAnnouncementLetters = async () => {
    ...
    try {
      ...
      for (let idx = 0; idx < students.length; idx++) {
        ...
        doc.text(`Letter ${idx + 1} of ${students.length} | Generated by Kimatu Analytics`, 105, 285, { align: 'center' });
      }
  ...
  const generateFeeStatements = async () => {
    ...
    try {
      ...
      for (let idx = 0; idx < students.length; idx++) {
        ...
        doc.setFontSize(7);
        doc.setTextColor(150, 150, 150);
        doc.text(`Statement ${idx + 1} of ${students.length} | Generated by Kimatu Analytics`, 105, 285, { align: 'center' });
      }
