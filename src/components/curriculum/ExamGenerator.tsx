      ...
      <div className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-5 space-y-2 rounded-xl border border-amber-100 bg-amber-50 p-3.5 text-xs text-amber-900">
            <label className="flex cursor-pointer items-start gap-2"><input type="checkbox" checked={includeImages} onChange={(event) => setIncludeImages(event.target.checked)} className="mt-0.5 rounded border-amber-300 text-red-600 focus:ring-red-500" /><span><strong>Generate automatic visuals.</strong> The AI will request precise diagrams, maps, tables, graphs, or illustrations only when a question genuinely requires one. Kimatu renders the visual deterministically for the browser preview and PDF; school-owned attachments remain available as a fallback.</span></label>
